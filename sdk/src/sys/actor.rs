...
extern "C" {
    ...
    pub fn resolve_address(addr_off: *const u8, addr_len: u32) -> (i32, u64);
    ...
    pub fn new_actor_address(obuf_off: *mut u8, obuf_len: u32) -> u32;
    ...
    pub fn create_actor(addr_off: *const u8, addr_len: u32, typ_off: *const u8);
}
