...
use fvm::{init_actor, system_actor, BaseKernel};
...
pub type IntegrationExecutor<B, E> =
    DefaultExecutor<DefaultFilecoinKernel<BaseKernel<DefaultCallManager<DefaultMachine<B, E>>>>>;
    ...
    E: Externs,
{
        ...
        G: FnOnce(&mut MachineContext),
    {
        ...
        let executor = DefaultExecutor::<
            DefaultFilecoinKernel<BaseKernel<DefaultCallManager<DefaultMachine<B, E>>>>,
        >::new(engine, machine)?;
