...
use fvm::{init_actor, system_actor, eam_actor, DefaultKernel};
...
use crate::builtin::{fetch_builtin_code_cid, set_init_actor, set_sys_actor, set_eam_actor};
    ...
    E: Externs,
{
    pub fn new(
        ...
        // EAM state
        let eam_state = eam_actor::State{ empty: vec![] };
        ...
        set_eam_actor(&mut state_tree, eam_code_cid, eam_state)?;
