pub use metamorphic_interface::*;
#[allow(clippy::too_many_arguments, non_camel_case_types)]
pub mod metamorphic_interface {
    #![allow(clippy::enum_variant_names)]
    #![allow(dead_code)]
    #![allow(clippy::type_complexity)]
    #![allow(unused_imports)]
    #[doc = "MetamorphicInterface was auto-generated with ethers-rs Abigen. More information at: https://github.com/gakonst/ethers-rs"]
    use std::sync::Arc;
    ...
    pub static METAMORPHICINTERFACE_ABI: ethers::contract::Lazy<ethers::core::abi::Abi> =
        ethers::contract::Lazy::new(|| {
            ethers::core::utils::__serde_json::from_str(__ABI).expect("invalid abi")
        });
    pub struct MetamorphicInterface<M>(ethers::contract::Contract<M>);
    impl<M> Clone for MetamorphicInterface<M> {
        fn clone(&self) -> Self {
            MetamorphicInterface(self.0.clone())
        }
    }
    impl<M> std::ops::Deref for MetamorphicInterface<M> {
        type Target = ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> std::fmt::Debug for MetamorphicInterface<M> {
        fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
            f.debug_tuple(stringify!(MetamorphicInterface))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ethers::providers::Middleware> MetamorphicInterface<M> {
        ...
        pub fn new<T: Into<ethers::core::types::Address>>(
            ...
            ethers::contract::Contract::new(
                address.into(),
                METAMORPHICINTERFACE_ABI.clone(),
                client,
            )
            .into()
        }
