...
pub mod butterfly {
    ...
    #[doc = "Butterfly was auto-generated with ethers-rs Abigen. More information at: https://github.com/gakonst/ethers-rs"]
    use std::sync::Arc;
    ...
    pub static BUTTERFLY_ABI: ethers::contract::Lazy<ethers::core::abi::Abi> =
        ethers::contract::Lazy::new(|| {
            ethers::core::utils::__serde_json::from_str(__ABI).expect("invalid abi")
        });
    pub struct Butterfly<M>(ethers::contract::Contract<M>);
    impl<M> Clone for Butterfly<M> {
        fn clone(&self) -> Self {
            Butterfly(self.0.clone())
        }
    }
    impl<M> std::ops::Deref for Butterfly<M> {
        type Target = ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> std::fmt::Debug for Butterfly<M> {
        fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
            f.debug_tuple(stringify!(Butterfly))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ethers::providers::Middleware> Butterfly<M> {
        ...
        pub fn new<T: Into<ethers::core::types::Address>>(
            ...
            ethers::contract::Contract::new(address.into(), BUTTERFLY_ABI.clone(), client).into()
        }
    ...
    impl<M: ethers::providers::Middleware> From<ethers::contract::Contract<M>> for Butterfly<M> {
