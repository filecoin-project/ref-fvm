...
pub fn price_list_by_network_version(network_version: NetworkVersion) -> &'static PriceList {
    match network_version {
        NetworkVersion::V21 | NetworkVersion::V22 | NetworkVersion::V23 | NetworkVersion::V24 | NetworkVersion::V25 | NetworkVersion::V26 => {
            &WATERMELON_PRICES
        }
        #[cfg(feature = "nv27-dev")]
        NetworkVersion::V27 => &WATERMELON_PRICES,
        * => panic!("network version {nv} not supported", nv = network_version),
    }
}
