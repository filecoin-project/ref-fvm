...
lazy_static! {
    ...
    pub static ref SYSTEM_ACTOR_CODE_ID: Cid = make_builtin_code_cid(b"fil/5/system");
    pub static ref INIT_ACTOR_CODE_ID: Cid = make_builtin_code_cid(b"fil/5/init");
    pub static ref CRON_ACTOR_CODE_ID: Cid = make_builtin_code_cid(b"fil/5/cron");
    pub static ref ACCOUNT_ACTOR_CODE_ID: Cid = make_builtin_code_cid(b"fil/5/account");
    pub static ref POWER_ACTOR_CODE_ID: Cid = make_builtin_code_cid(b"fil/5/storagepower");
    pub static ref MINER_ACTOR_CODE_ID: Cid = make_builtin_code_cid(b"fil/5/storageminer");
    pub static ref MARKET_ACTOR_CODE_ID: Cid = make_builtin_code_cid(b"fil/5/storagemarket");
    pub static ref PAYCH_ACTOR_CODE_ID: Cid = make_builtin_code_cid(b"fil/5/paymentchannel");
    pub static ref MULTISIG_ACTOR_CODE_ID: Cid = make_builtin_code_cid(b"fil/5/multisig");
    pub static ref REWARD_ACTOR_CODE_ID: Cid = make_builtin_code_cid(b"fil/5/reward");
    pub static ref VERIFREG_ACTOR_CODE_ID: Cid = make_builtin_code_cid(b"fil/5/verifiedregistry");
    pub static ref CHAOS_ACTOR_CODE_ID: Cid = make_builtin_code_cid(b"fil/5/chaos");
}
