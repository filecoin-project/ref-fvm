...
// Q: We have ipld_open, do we have ipld_close?
...
extern "C" {
    ...
    pub fn ipld_getRoot(cid: *mut u8, cid_max_len: u32) -> u32;

    /// Sets the root CID. The new root must be in the reachable set.
    pub fn ipld_setRoot(cid: *const u8);
    ...
    pub fn ipld_open(cid: *const u8) -> (u32, u64, u32);
    ...
    pub fn ipld_create(codec: u64, data: *const u8, len: u32) -> u32;

    /// Reads the identified block into obuf, starting at offset, reading _at most_ len bytes.
    /// Returns the number of bytes read.
    pub fn ipld_read(id: u32, obuf: *mut u8, offset: u32, max_len: u32) -> u32;

    /// Returns the codec and size of the specified block.
    pub fn ipld_stat(id: u32) -> (u64, u32);
    ...
    pub fn ipld_cid(id: u32, hash_fun: u64, hash_len: u32, cid: *mut u8, cid_max_len: u32) -> u32;
}
